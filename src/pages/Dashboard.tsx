  ...
  const pieData = useMemo(() => {
    ...
    return Object.entries(map)
      .map(([id, value]) => {
        ...
        return { name: `${cat?.icon ?? ''} ${cat?.name ?? 'Diğer'}`, value, color: cat?.color ?? '#94a3b8' }
      })
    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Finansal durumunuza genel bakış</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card>
          <CardContent className="p-5">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mb-1">Toplam Gelir</p>
        ...
        <Card>
          <CardContent className="p-5">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mb-1">Toplam Gider</p>
        ...
        <Card>
          <CardContent className="p-5">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mb-1">Net Bakiye</p>
                <p className={`text-2xl font-bold tabular-nums ${net >= 0 ? 'text-violet-500' : 'text-red-500'}`}>
            ...
            {recentTx.length === 0 ? (
              ...
              <div className="space-y-2">
                {recentTx.map((tx) => {
                  ...
                  return (
                    <div key={tx.id} className="flex items-center gap-3 p-2.5 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                      <div
